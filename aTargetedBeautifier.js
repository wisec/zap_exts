...
function dump(a){return print(a)}
	...
	if (extHist != null) {
	    ...
	    while (hr = extHist.getHistoryReference(i), hr) {
			...
			if (prefix.equals(url.substr(0,prefix.length()))) {
                    body = hr.getHttpMessage().getResponseBody()+''; // toString() will return a java.lang.String object - we want js strings.
                    print(js_beautify( body,{keep_array_indentation:true,preserve_newlines:true,preserve_max_newlines:1}))
